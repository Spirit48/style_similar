...
class Mall(models.Model):
    ...
    mall_category = models.CharField(max_length=20, null=True)
    ...
    @classmethod
    def update_or_create_mall(cls, mall_image_id, mall_name=None, mall_brand=None, mall_price=None, mall_category=None, mall_url=None, review_keyword=None, sentiment_percent=None):
        ...
        mall, created = cls.objects.update_or_create(
            ...
            defaults={
                ...
                'review_sentiment': sentiment_percent,
            }
        )
